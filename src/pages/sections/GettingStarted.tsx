    ...
    return (
      <div className=" mx-auto px-6 py-10  ">
        ...
        <section id="introduction" className="mb-12">
          <h1 className="text-4xl font-bold my-8 leading-tight">Introduction</h1>
        ...
        <section id="installation" className="mb-12">
          ...
          <h3 className="text-xl font-semibold mt-6 mb-2">🔧 Option 1: NPM</h3>
          <pre className="bg-gray-100 text-sm text-gray-800 p-4 rounded overflow-x-auto">
            <code>
              npm install bootwind
            </code>
          </pre>
  
          <p className="text-sm text-gray-600 mt-2">Then import it in your main CSS or JS file:</p>
          <pre className="bg-gray-100 text-sm text-gray-800 p-4 rounded overflow-x-auto">
            <code>
              {'@import "bootwind";'}
            </code>
        ...
        <section id="usage" className="mb-12">
          ...
          <pre className=" p-4 rounded-lg overflow-x-auto shadow-lg">
